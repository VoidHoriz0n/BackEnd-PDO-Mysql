...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Jun-2021 às 03:10
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `clienteUsuario` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `itens` (
  ...
  PRIMARY KEY (`Venda_idVenda`,`Produto_codigoProduto`),
  KEY `fk_Venda_has_Produto_Produto1` (`Produto_codigoProduto`)
...
CREATE TABLE IF NOT EXISTS `movimento` (
  ...
  PRIMARY KEY (`idVenda`,`cliente`),
  KEY `fk_Venda_Cliente1_idx` (`cliente`)
...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  PRIMARY KEY (`codigoProduto`,`Categoria_codigoCategoria`),
  KEY `fk_Produto_Categoria1_idx` (`Categoria_codigoCategoria`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `unidade` (
  `codigoUnidade` int(11) NOT NULL AUTO_INCREMENT,
  `descricaoUnidade` varchar(30) NOT NULL,
...
INSERT INTO `unidade` (`codigoUnidade`, `descricaoUnidade`, `siglaUnidade`) VALUES
(1, 'Caixa', 'CX'),
(2, 'Unidade', 'UN'),
(3, 'Kilograma', 'KG'),
(4, 'Litro', 'LT'),
...
--
ALTER TABLE `itens`
  ADD CONSTRAINT `fk_Venda_has_Produto_Produto1` FOREIGN KEY (`Produto_codigoProduto`) REFERENCES `produto` (`codigoProduto`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Venda_has_Produto_Venda1` FOREIGN KEY (`Venda_idVenda`) REFERENCES `movimento` (`idVenda`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `produto`
--
ALTER TABLE `produto`
  ADD CONSTRAINT `fk_Produto_Categoria1` FOREIGN KEY (`Categoria_codigoCategoria`) REFERENCES `categoria` (`codigoCategoria`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
